...
public class Supervisor {
	public static void main(String[] args) {
		...
		ps_o1.SetName("ps_i2");
		ps_o1.Value = new TransferOperation("localhost", "1080", "ps_i1");
		...
		//grdTs1.Activations.add(new Activation(ts_1, "ps_1", TransitionOperation.Move, "ps_1"));
		...
		//Condition Ts2Ct4 = new Condition(ts_2, "ps_1", TransitionCondition.Equal, "ps_2");
		//Condition Ts2Ct5 = new Condition(ts_2, "ps_2", TransitionCondition.Equal, "ps_3");
		...
		//.Activations.add(new Activation(ts_2, "ps_1", TransitionOperation.Move, "ps_3"));
		...
		grdTs3.Activations.add(new Activation(ts_3, "ps_i2", TransitionOperation.Move, "ps_2"));
		grdTs3.Activations.add(new Activation(ts_3, "ps_i2", TransitionOperation.Move, "ps_o2"));
